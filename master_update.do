...
do analyze/lawyers_janitors.do // FILES NEEDED TO RUN THIS ARE MISSING
*/
***MICRO DATA ANALYSIS***
...
//do analyze/mig_returns_and_flows.do //FIGURE 3, 4, 5, APPENDIX TABLE 3, 4* // FILES NEEDED TO RUN THIS ARE MISSING
