...
use serial statefip year gq migplac5 race bpl migsea rent valueh educ incwage sea age perwt hhwt labforce using $src/data17
...
if `j'==3 {
drop mig
gen mig =  migsea!=sea & statefip!=migplac5
}

if `j'==4 {
drop mig
gen mig =  migsea!=sea & race==1
}
...
save $work/BORJAS1940ROBUST`j', replace
